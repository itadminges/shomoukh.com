/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env=production --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 0096b37d5755990810bb473f2b5a3220)
...
interface __BaseEnv_CloudflareEnv {
	...
	FORM_IT_RECIPIENT: string;
	FORM_AL_MOUJ_RECIPIENT: string;
	FORM_AL_QURUM_RECIPIENT: string;
	FORM_ALLOWED_ORIGIN: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RESEND_API_KEY" | "FORM_FROM_EMAIL" | "FORM_IT_RECIPIENT" | "FORM_AL_MOUJ_RECIPIENT" | "FORM_AL_QURUM_RECIPIENT" | "FORM_ALLOWED_ORIGIN">> {}
}
